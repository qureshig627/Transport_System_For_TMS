...
<body>
	...
	<div class="w3-container" style="padding:128px 16px;">
		...
		<h1>customer</h1>
			<form class="form-horizontal" name="customerform" action="customer_submit.php" method="post" >
				<div class="row">
					<div class="col-25">
						<label> Name </label>
					</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" name="mobile" maxlength="15" required value="<?php if(isset($row['mobile_no']) && $row['mobile_no']){ echo $row['mobile_no'];}?>"/>
					</div>
				</div>
                <div class="row">
					<div class="col-25">
					...
					<div class="col-75">
						<textarea name="address" rows="3" maxlength="250"> <?php if(isset($row['address']) && $row['address']){ echo $row['address'];}?> </textarea>
					</div>
				</div>
				<div class="row w3-center">
					<a href="customer.php" class="button">Cancel</a>
